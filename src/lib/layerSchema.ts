...
// Replaces the flat "Design DNA JSONL → single raster" pipeline with an
// editable, render-agnostic representation. Each layer can be moved, hidden,
// restyled, or re-rendered independently.
