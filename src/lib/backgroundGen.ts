...
// editable text layers rendered on top (see LayerEditor / layerRenderer), so
// the owner can still edit wording, price, font size and color after
...
// pipeline (heuristic / photo / gradient backgrounds) keeps working.
