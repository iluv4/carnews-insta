...
-- CreateIndex
CREATE UNIQUE INDEX "AnalysisCache_shortcode_key" ON "AnalysisCache"("shortcode");
...
-- AddForeignKey
ALTER TABLE "GeneratedCard" ADD CONSTRAINT "GeneratedCard_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
