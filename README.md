...
- **AI 기반 이미지 변환 (선택):** 추출한 이미지 중 하나를 선택하고, OpenAI의 GPT-Image-2를 사용하여 특정 테마와 레퍼런스 스타일에 맞는 카드 뉴스용 배경 이미지로 재생성할 수 있습니다.
- **모던 UI:** Next.js와 React를 기반으로 구축되었으며, 이미지 추출, 다중 선택, AI 변환까지 한 화면에서 물 흐르듯 처리할 수 있는 깔끔한 인터페이스를 제공합니다.
